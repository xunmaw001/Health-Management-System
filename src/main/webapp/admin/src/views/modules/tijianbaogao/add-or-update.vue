<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐类型" prop="taocanleixing">
          <el-input v-model="ruleForm.taocanleixing" 
              placeholder="套餐类型" clearable  :readonly="ro.taocanleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检项目" prop="tijianxiangmu">
          <el-input v-model="ruleForm.tijianxiangmu" 
              placeholder="体检项目" clearable  :readonly="ro.tijianxiangmu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="报告文件" prop="baogaowenjian">
          <file-upload
          tip="点击上传报告文件"
          action="file/upload"
          :limit="1"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="体检结果" prop="tijianjieguo">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tijianjieguo" label="体检结果" prop="tijianjieguo">
                    <span>{{ruleForm.tijianjieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baogaowenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
