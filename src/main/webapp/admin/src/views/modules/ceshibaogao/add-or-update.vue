<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="测评类型" prop="cepingleixing">
          <el-input v-model="ruleForm.cepingleixing" 
              placeholder="测评类型" clearable  :readonly="ro.cepingleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="测评报告" prop="cepingbaogao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="测评报告"
                  v-model="ruleForm.cepingbaogao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cepingbaogao" label="测评报告" prop="cepingbaogao">
                    <span>{{ruleForm.cepingbaogao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="医生建议" prop="yishengjianyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yishengjianyi" label="医生建议" prop="yishengjianyi">
                    <span>{{ruleForm.yishengjianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cepingleixing = true;
          ...
          if(o=='cepingbaogao'){
            this.ruleForm.cepingbaogao = obj[o];
	    this.ro.cepingbaogao = true;
            continue;
          }
          if(o=='pingfen'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `ceshibaogao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ceshibaogaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
